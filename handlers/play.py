        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"• **Merhaba** {user.first_name}, **asistan yoğun katılma istekleri nedeniyle grubunuza katılamadı. Grupta yasaklı olmadığından emin olun ve daha sonra yeniden deneyin !**")
    try:
